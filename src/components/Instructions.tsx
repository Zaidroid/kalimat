...
/**
 * Displays the game instructions in a modal.
 */
        ...
        <div className="space-y-4 text-gray-800 dark:text-gray-200">
          ...
          <div className="border-t border-b border-gray-300 dark:border-gray-700 py-4 my-4">
            ...
            <div className="flex items-center mb-2 gap-1">
              <div className="w-10 h-10 bg-green-500 dark:bg-green-600 rounded flex items-center justify-center text-white font-bold">
                م
              </div>
              <div className="w-10 h-10 border-2 border-gray-300 dark:border-gray-600 rounded flex items-center justify-center">
                د
              </div>
              <div className="w-10 h-10 border-2 border-gray-300 dark:border-gray-600 rounded flex items-center justify-center">
                ر
            ...
            <div className="flex items-center mb-2 mt-4 gap-1">
              ...
              <div className="w-10 h-10 yellow-500 dark:bg-yellow-600 bg-yellow-500 rounded flex items-center justify-center text-white font-bold">
                ت
              </div>
              <div className="w-10 h-10 border-2 border-gray-300 dark:border-gray-600 rounded flex items-center justify-center">
                ب
            ...
            <div className="flex items-center mb-2 mt-4 gap-1">
              ...
              <div className="w-10 h-10 bg-gray-500 dark:bg-gray-600 rounded flex items-center justify-center text-white font-bold">
                ة
              </div>
            </div>
